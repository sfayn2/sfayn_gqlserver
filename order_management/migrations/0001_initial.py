# Generated by Django 5.1.4 on 2025-09-06 13:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TenantWorkflowSnapshot',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.CharField(max_length=150)),
                ('workflow', models.CharField(help_text='eg. [ {"status": "NoPendingActions", "optional": true, "commands": ["PlaceOrderCommand"] } ]', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optional_step', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_free_gift', models.BooleanField(blank=True, default=False, null=True)),
                ('is_taxable', models.BooleanField(blank=True, default=True, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('last_update_dt', models.DateTimeField(auto_now=True)),
            ],
            options={
