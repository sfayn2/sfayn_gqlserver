# Generated by Django 5.2.6 on 2025-11-17 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_ref', models.CharField(blank=True, help_text='{app}-{identifier} . eg. checkoutapp-1234', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='LineItem',
            fields=[
                ('product_sku', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ...
                ('package_weight_kg', models.CharField(blank=True, help_text='value should be coming from product itself or to fill in later once it goes to warehouse fulfillment?', max_length=100, null=True)),
