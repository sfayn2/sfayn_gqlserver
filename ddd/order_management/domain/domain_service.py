...
from ddd.order_management.domain import models, value_objects, exceptions, enums
...
class OrderService(OrderServiceAbstract):
...
class DraftOrderServiceAbstract(ABC):
...
class DraftOrderService(DraftOrderServiceAbstract):
    def create_draft_order(
            customer_details: value_objects.CustomerDetails,
            shipping_address: value_objects.Address,
            line_items: List[models.LineItem]
