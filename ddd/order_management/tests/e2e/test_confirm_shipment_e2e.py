...
from ddd.order_management.presentation.graphql.mutations.confirm_shipment_mutation import ConfirmShipmentMutation 
...
def test_graphql_endpoint_confirm_shipment_successfully_e2e(
 ...
 # The GraphQL mutation query updated for ConfirmShipment
    ...
    expected_message = f"Order {target_order_id} w Shipment Id {target_shipment_id} successfully confirmed."
