...
def test_add_line_items_draft_only(
    ...
    command = commands.AddLineItemsCommand(
        ...
        product_skus=fake_product_skus_draft_only
    )
    ...
    assert response.message == "Only draft order can add line item."
