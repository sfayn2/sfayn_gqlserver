...
def fake_product_skus(test_constants):
    return [dtos.ProductSkusDTO(vendor_id=test_constants["vendor1"], product_sku="sku_remove1", order_quantity=22)]

@pytest.mark.django_db
def test_remove_line_items_ok(
    ...
    assert response.message == "Order ORD-REMOVEITEMS-1 successfully remove line items."
