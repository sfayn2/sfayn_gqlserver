...
def bootstrap_onprem():
    """Bootstrap DDD Order Management Service for On-Premise Deployment.
    Configures infrastructure services, event handlers, command/query handlers,
    and cross-cutting concerns specific to on-premise environments.
    """
    ...
    GraphqlContext.configure(
        ...
        header_extractor=header_extractor.DjangoHeaderExtractor()
    )
