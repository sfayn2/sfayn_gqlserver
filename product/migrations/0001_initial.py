# Generated by Django 4.2 on 2023-06-03 12:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product2variantitem', to='product.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_variant', models.ManyToManyField(blank=True, related_name='prodvariant2tag', to='product.variantitem')),
            ],
        ),
    ]
